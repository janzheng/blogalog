...
const allowedOrigins = ['https://restfox.dev', 'https://blogalog.net', 'http://localhost:3055', 'https://makereal.tldraw.com'];
...
export async function corsHandler({ event, resolve }) {
  ...
  if (!allowedOrigins.includes(origin)) {
    origin = allowedOrigins[0]; // Default to the first allowed origin
  }
