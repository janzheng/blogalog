...
export function generatePageStyles(settingsPage, settings={}) {
  ...
  const acceptedKeys = [
    ...
    '--notion-h1',
    '--notion-h1-weight',
    '--notion-h1-line-height',
    '--notion-h1-margin-top',
    '--notion-h1-padding-bottom',
    '--notion-h2',
    '--notion-h2-weight',
    '--notion-h2-line-height',
    '--notion-h2-margin-top',
    '--notion-h2-padding-bottom',
    '--notion-h3',
    '--notion-h3-weight',
    '--notion-h3-line-height',
    '--notion-h3-margin-top',
    '--notion-h3-padding-bottom',
    '--notion-p-padding',
